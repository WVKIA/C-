...
static const char qt_meta_stringdata_mydialog[] = {
    "mydialog\0\0,,\0digsig(bool,QString,int)\0"
    "yes()\0no()\0"
};
...
void mydialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->digsig((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->yes(); break;
        case 2: _t->no(); break;
        default: ;
        }
...
// SIGNAL 0
void mydialog::digsig(bool _t1, QString _t2, int _t3)
{
