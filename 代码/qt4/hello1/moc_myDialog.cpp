...
static const char qt_meta_stringdata_myDialog[] = {
    "myDialog\0\0valueChanged(int)\0valueChang(int)\0"
    "valueUpdate()\0"
};
...
void myDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->valueChang((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->valueUpdate(); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void myDialog::valueChanged(int _t1)
{
