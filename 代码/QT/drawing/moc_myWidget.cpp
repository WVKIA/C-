...
**
** Created: Thu Sep 17 16:17:25 2015
...
static const char qt_meta_stringdata_myWidget[] = {
    "myWidget\0\0dlgAccept()\0dlgvalueChange(int)\0"
};
...
int myWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dlgAccept(); break;
        case 1: dlgvalueChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
